...
function LoginForm({ onSwitch }) {
  ...
  useEffect(() => {
    // Nếu vào trang login từ trang khác, lưu lại đường dẫn trước đó
  ...
  if (user) return null;
  return (
    <div className="flex max-w-4xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden relative z-10 mx-4">
      ...
      <div className="flex-1 p-12 flex flex-col justify-center relative" style={{
        ...
        <svg className="absolute inset-0 w-full h-full" style={{ zIndex: 0 }}>
          <path d="M0,50 Q100,20 200,50 T400,50" stroke="rgba(255,255,255,0.15)" strokeWidth="3" fill="none" />
          <path d="M50,150 Q150,120 250,150 T450,150" stroke="rgba(255,255,255,0.1)" strokeWidth="2" fill="none" />
          <path d="M-50,250 Q50,220 150,250 T350,250" stroke="rgba(255,255,255,0.1)" strokeWidth="2" fill="none" />
        </svg>
      ...
      <div className="flex-1 px-12 py-16 flex flex-col justify-center bg-white/5 backdrop-blur-md border border-white/30 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 text-gray-700 placeholder-gray-400"
                required
              />
            </div>
            {/* Password field */}
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 text-gray-700 placeholder-gray-400"
                required
              />
              <button
                type="button"
...
function RegisterForm({ onSwitch }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Nếu đăng ký thành công thì chuyển sang login (onSwitch)
